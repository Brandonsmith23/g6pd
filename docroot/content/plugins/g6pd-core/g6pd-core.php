<?php
/*
Plugin Name: G6PD Core
Description: Core Plugin For G6PD
Version: 0.1
Author: newmedia
Author URI: http://newmediadenver.com/
Text Domain: g6pd-core
 ...
 * @since 1.0
 */
final class g6pdcore {

  public static $version = '0.1';
  public static $name = 'g6pd-core';
  ...
  /**
   * Main g6pdcore Instance
   *
   * Ensures only one instance of g6pdcore is loaded or can be loaded.
   *
   * @static
   * @return g6pdcore - Main instance
   */
  ...
  /**
   * Init g6pdcore when WordPress Initialises.
   *
   * @access public
   * @return void
   */
